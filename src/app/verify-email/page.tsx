        ...
        <form onSubmit={handleVerify} className="mt-6 space-y-6" noValidate>
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 bg-white px-3 py-3 text-sm text-slate-900 transition-colors focus:border-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-600/20"
